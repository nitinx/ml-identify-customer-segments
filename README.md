...
Our Bertelsmann partners AZ Direct and Arvato Financial Solutions have provided two datasets one with demographic information about the people of Germany [`Udacity_AZDIAS_Subset.csv`], and one with that same information for customers of a mail-order sales company [`Udacity_CUSTOMERS_Subset.csv`]. Additionally, a data dictionary [`Data_Dictionary.md`] providing information on the features is also provided. 
